...
#if DEBUG == 1  // change to one to enable debugging
...
void init_blefind() {
  ...
  pCharacteristic->setValue("Device is ready");
  ...
  debugln("Characteristic defined!");
}
